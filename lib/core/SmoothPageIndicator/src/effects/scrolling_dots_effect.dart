...
import 'package:task/core/SmoothPageIndicator/src/painters/scrolling_dots_painter.dart';
import 'package:task/core/SmoothPageIndicator/src/painters/scrolling_dots_painter_with_fixed_center.dart';
...
class ScrollingDotsEffect extends IndicatorEffect {
  ...
  IndicatorPainter buildPainter(int count, double offset, bool isRTL) {
    if (fixedCenter) {
      ...
      return ScrollingDotsPainter(count: count, offset: offset, effect: this, isRTL: isRTL);
    }
  }
}
