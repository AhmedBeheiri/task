...
import 'package:task/core/SmoothPageIndicator/src/effects/swap_effect.dart';
...
class SwapPainter extends IndicatorPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = count - 1; i >= 0; i--) {
      ...
      final rRect = RRect.fromLTRBR(xPos, yPos - effect.dotHeight / 2, xPos + effect.dotWidth,
          yPos + effect.dotHeight / 2, dotRadius);
