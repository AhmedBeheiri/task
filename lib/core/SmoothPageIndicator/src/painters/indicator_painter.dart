...
import 'package:task/core/SmoothPageIndicator/src/effects/indicator_effect.dart';
...
abstract class IndicatorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      final bounds = Rect.fromLTRB(xPos, yPos - _effect.dotHeight / 2, xPos + _effect.dotWidth,
